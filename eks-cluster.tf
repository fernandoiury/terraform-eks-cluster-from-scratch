  ...
  worker_groups = [
    {
      ...
      # to enable autoscaling: https://github.com/terraform-aws-modules/terraform-aws-eks/blob/master/docs/autoscaling.md
    },
  ]
...
# policy required by aws-alb-ingress-controller
...
resource "aws_iam_role_policy" "alb-policy" {
  name = "aws-alb-ingress-controller_policy_${var.cluster_name}"
